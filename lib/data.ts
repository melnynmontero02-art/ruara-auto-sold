...
/* ──────────────────────────────────────────────────────────────
   IMÁGENES — CÓMO AGREGAR TUS FOTOS REALES
   ──────────────────────────────────────────────────────────────
   Coloca tus fotos en la carpeta:
     /public/images/cars/
   con estos nombres exactos:

     car-01.jpg  →  Ford Explorer 2018
     car-02.jpg  →  Nissan Kicks 2020
     car-03.jpg  →  Mazda CX-5 2020
     car-04.jpg  →  Hyundai Santa Fe 2016
     car-05.jpg  →  Honda CR-V 2024
     car-06.jpg  →  Citroën C3 2022
     car-07.jpg  →  Honda Civic 2022
     car-08.jpg  →  Hyundai Elantra 2020
     car-09.jpg  →  Nissan Note 2020
     car-10.jpg  →  Toyota Yaris 2021
     car-11.jpg  →  Ford Fusion 2019
     car-12.jpg  →  Ford F-150 2020
     car-13.jpg  →  Kia Optima 2019
     car-14.jpg  →  Daihatsu Hijet 2020

   Hero:
     /public/images/hero-bg.jpg  →  Tu mejor foto exterior del dealer

   Galería (6 fotos):
     /public/images/gallery/gal-1.jpg … gal-6.jpg

   Mientras no hayas puesto tus fotos se muestran fotos de referencia.
   ────────────────────────────────────────────────────────────── */
...
export interface Vehicle {
  ...
  transmission: string
  mileage: string
  image: string          // ruta local — reemplaza con tu foto real
  fallback: string       // imagen de referencia mientras no hay foto local
...
export const vehicles: Vehicle[] = [
  ...
  },
  {
    ...
    fallback: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=800&q=80',
    tag: 'DISPONIBLE',
    badge: 'Importado Japón',
    color: 'Negro',
  },
]

/* ──────────────────────────────────────────────────────────────
   GALERÍA — usa tus mejores fotos del dealer
   ────────────────────────────────────────────────────────────── */
...
export const testimonials = [
  {
    ...
    rating: 5,
    quote: 'Excelente servicio. Me aprobaron el financiamiento en menos de 24 horas. Mi Ford Explorer está impecable.',
  ...
  },
  {
    ...
    city: 'Boca Chica',
    rating: 5,
    quote: 'Compré mi Elantra con inicial bajita y el proceso fue muy rápido. El equipo de RUARA es honesto y profesional.',
  ...
  },
  {
    ...
    rating: 5,
    quote: 'Busqué en varios dealers y ninguno me dio el trato que recibí aquí. La inicial fue flexible y el banco aprobó rápido.',
  ...
  },
  {
    ...
    rating: 5,
    quote: 'Mi Honda CRV llegó en perfectas condiciones. Documentación completa y sin sorpresas. Totalmente confiable.',
  ...
  },
  {
    ...
    city: 'La Romana',
    rating: 5,
    quote: 'Tercera vez que compro con RUARA. Siempre el mejor trato, los mejores precios y aprobación rápida.',
  ...
  },
  {
    ...
    city: 'Santiago',
    rating: 5,
    quote: 'Me ayudaron a escoger el Nissan Kicks ideal para mi presupuesto. El asesor fue muy paciente y claro.',
    vehicle: 'Nissan Kicks 2020',
  },
]
